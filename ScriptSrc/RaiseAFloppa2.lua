...
Tabs.stat = Window:Section({
    ...
    Tabs.plant = Tabs.main:Tab({ Title = "Planter", Icon = "sprout" })
    Tabs.raid = Tabs.main:Tab({ Title = "Raid (W.I.P)", Icon = "swords", Locked = "true" })
    Tabs.sci = Tabs.main:Tab({ Title = "Flopptonium", Icon = "atom" })
...
Tabs.sci:Section({ Title = "Explanation", Icon = "book-copy"})
	
Tabs.sci:Paragraph({
	Title = "How does this work",
	Desc = "You need to have Flopptonium Reactor purchased to make this work and you also have to stand near the Flopptonium Reactor",
	Locked = false,
})

Tabs.sci:Section({ Title = "Function", Icon = "atom"})

Tabs.sci:Button({
    Title = "Get Floppotonium",
    Desc = "Self explained (You can spam this as much as you want)",
    Locked = false,
    Callback = function()
        local prompt = workspace.Unlocks["Flopptonium Reactor"].PRIMARY.ProximityPrompt
        fireproximityprompt(prompt)
    end
})

Tabs.sci:Button({
    Title = "Teleport To Flopptonium Reactor",
    Desc = "Teleport yourself in front of the reactor",
    Locked = false,
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-63.7463188, 91.4000168, -112.542473, 0.769942284, 5.4422383e-08, 0.638113499, -5.68362282e-08, 1, -1.67082597e-08, -0.638113499, -2.34035689e-08, 0.769942284)
    end
})
